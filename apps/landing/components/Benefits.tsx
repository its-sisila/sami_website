      ...
      <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
        {benefits.map((b, i) => (
          <motion.div
            ...
            whileHover={{ y: -5 }}
            className="group relative p-6 rounded-2xl border border-neutral-200 dark:border-neutral-800 bg-white/50 dark:bg-neutral-900/50 backdrop-blur-sm hover:border-brand-600/30 transition-all duration-300"
          >
            ...
            <div className="relative z-10">
              <div className="w-12 h-12 rounded-lg bg-brand-100 dark:bg-brand-900/30 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300 border border-brand-500/20">
                <b.icon className="h-6 w-6 text-brand-600 dark:text-brand-500" />
              </div>

              <h3 className="text-lg font-bold mb-3 text-neutral-900 dark:text-neutral-100 group-hover:text-brand-600 dark:group-hover:text-brand-400 transition-colors">
                {b.metric}
              </h3>
